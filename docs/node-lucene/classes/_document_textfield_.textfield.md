...
[Globals](../README.md) / ["document/TextField"](../modules/_document_textfield_.md) / [TextField](_document_textfield_.textfield.md) /

# Class: TextField

## Hierarchy

  * [Field](_document_field_.field.md)
...
* [constructor](_document_textfield_.textfield.md#constructor)

### Properties

* [_java](_document_textfield_.textfield.md#_java)

### Methods

* [_javaClassName](_document_textfield_.textfield.md#_javaclassname)
* [equals](_document_textfield_.textfield.md#equals)
* [equalsAsync](_document_textfield_.textfield.md#equalsasync)
* [equalsPromise](_document_textfield_.textfield.md#equalspromise)
* [equalsSync](_document_textfield_.textfield.md#equalssync)
* [getClass](_document_textfield_.textfield.md#getclass)
* [hashCode](_document_textfield_.textfield.md#hashcode)
* [toString](_document_textfield_.textfield.md#tostring)
* [toStringAsync](_document_textfield_.textfield.md#tostringasync)
* [toStringPromise](_document_textfield_.textfield.md#tostringpromise)
* [toStringSync](_document_textfield_.textfield.md#tostringsync)
* [_buildArraySync](_document_textfield_.textfield.md#static-_buildarraysync)
* [_buildAsync](_document_textfield_.textfield.md#static-protected-_buildasync)
* [_buildJavaArray](_document_textfield_.textfield.md#static-_buildjavaarray)
* [_buildPromise](_document_textfield_.textfield.md#static-protected-_buildpromise)
* [_buildSync](_document_textfield_.textfield.md#static-protected-_buildsync)
* [_buildSyncOrThrow](_document_textfield_.textfield.md#static-protected-_buildsyncorthrow)
* [_getNative](_document_textfield_.textfield.md#static-_getnative)
* [_javaClassName](_document_textfield_.textfield.md#static-_javaclassname)
* [class](_document_textfield_.textfield.md#static-class)

## Constructors

###  constructor

\+ **new TextField**(`fieldName`: string, `fieldValue`: string, `fieldStore`: [FieldStore](_document_fieldstore_.fieldstore.md)): *[TextField](_document_textfield_.textfield.md)*

*Overrides void*

*Defined in [document/TextField.ts:5](https://github.com/cancerberoSgx/node-lucene/blob/7855316/node-lucene/src/document/TextField.ts#L5)*
...
`fieldName` | string |
`fieldValue` | string |
`fieldStore` | [FieldStore](_document_fieldstore_.fieldstore.md) |

**Returns:** *[TextField](_document_textfield_.textfield.md)*
...
*Defined in [document/TextField.ts:11](https://github.com/cancerberoSgx/node-lucene/blob/7855316/node-lucene/src/document/TextField.ts#L11)*
