...
[Globals](../README.md) / ["store/Directory"](../modules/_store_directory_.md) / [Directory](_store_directory_.directory.md) /
...
* [constructor](_store_directory_.directory.md#constructor)

### Properties

* [_java](_store_directory_.directory.md#_java)

### Methods

* [_javaClassName](_store_directory_.directory.md#_javaclassname)
* [close](_store_directory_.directory.md#close)
* [equals](_store_directory_.directory.md#equals)
* [equalsAsync](_store_directory_.directory.md#equalsasync)
* [equalsPromise](_store_directory_.directory.md#equalspromise)
* [equalsSync](_store_directory_.directory.md#equalssync)
* [getClass](_store_directory_.directory.md#getclass)
* [hashCode](_store_directory_.directory.md#hashcode)
* [toString](_store_directory_.directory.md#tostring)
* [toStringAsync](_store_directory_.directory.md#tostringasync)
* [toStringPromise](_store_directory_.directory.md#tostringpromise)
* [toStringSync](_store_directory_.directory.md#tostringsync)
* [_buildArraySync](_store_directory_.directory.md#static-_buildarraysync)
* [_buildAsync](_store_directory_.directory.md#static-protected-_buildasync)
* [_buildJavaArray](_store_directory_.directory.md#static-_buildjavaarray)
* [_buildPromise](_store_directory_.directory.md#static-protected-_buildpromise)
* [_buildSync](_store_directory_.directory.md#static-protected-_buildsync)
* [_buildSyncOrThrow](_store_directory_.directory.md#static-protected-_buildsyncorthrow)
* [_getNative](_store_directory_.directory.md#static-_getnative)
* [_javaClassName](_store_directory_.directory.md#static-_javaclassname)
* [class](_store_directory_.directory.md#static-class)

## Constructors

###  constructor

\+ **new Directory**(): *[Directory](_store_directory_.directory.md)*

*Inherited from void*

Defined in /Users/sebastiangurin/git/node-lucene/node-lucene/node_modules/node-java-rt/dist/src/java/lang/Object.d.ts:4

**Returns:** *[Directory](_store_directory_.directory.md)*
