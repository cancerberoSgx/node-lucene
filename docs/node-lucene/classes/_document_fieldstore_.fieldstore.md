...
[Globals](../README.md) / ["document/FieldStore"](../modules/_document_fieldstore_.md) / [FieldStore](_document_fieldstore_.fieldstore.md) /
...
* [constructor](_document_fieldstore_.fieldstore.md#constructor)

### Properties

* [_java](_document_fieldstore_.fieldstore.md#_java)

### Accessors

* [NO](_document_fieldstore_.fieldstore.md#static-no)
* [YES](_document_fieldstore_.fieldstore.md#static-yes)

### Methods

* [_javaClassName](_document_fieldstore_.fieldstore.md#_javaclassname)
* [equals](_document_fieldstore_.fieldstore.md#equals)
* [equalsAsync](_document_fieldstore_.fieldstore.md#equalsasync)
* [equalsPromise](_document_fieldstore_.fieldstore.md#equalspromise)
* [equalsSync](_document_fieldstore_.fieldstore.md#equalssync)
* [getClass](_document_fieldstore_.fieldstore.md#getclass)
* [hashCode](_document_fieldstore_.fieldstore.md#hashcode)
* [toString](_document_fieldstore_.fieldstore.md#tostring)
* [toStringAsync](_document_fieldstore_.fieldstore.md#tostringasync)
* [toStringPromise](_document_fieldstore_.fieldstore.md#tostringpromise)
* [toStringSync](_document_fieldstore_.fieldstore.md#tostringsync)
* [_buildArraySync](_document_fieldstore_.fieldstore.md#static-_buildarraysync)
* [_buildAsync](_document_fieldstore_.fieldstore.md#static-protected-_buildasync)
* [_buildJavaArray](_document_fieldstore_.fieldstore.md#static-_buildjavaarray)
* [_buildPromise](_document_fieldstore_.fieldstore.md#static-protected-_buildpromise)
* [_buildSync](_document_fieldstore_.fieldstore.md#static-protected-_buildsync)
* [_buildSyncOrThrow](_document_fieldstore_.fieldstore.md#static-protected-_buildsyncorthrow)
* [_getNative](_document_fieldstore_.fieldstore.md#static-_getnative)
* [_javaClassName](_document_fieldstore_.fieldstore.md#static-_javaclassname)
* [class](_document_fieldstore_.fieldstore.md#static-class)

## Constructors

###  constructor

\+ **new FieldStore**(): *[FieldStore](_document_fieldstore_.fieldstore.md)*

*Inherited from void*

Defined in /Users/sebastiangurin/git/node-lucene/node-lucene/node_modules/node-java-rt/dist/src/java/lang/Object.d.ts:4

**Returns:** *[FieldStore](_document_fieldstore_.fieldstore.md)*
...
• **get NO**(): *[FieldStore](_document_fieldstore_.fieldstore.md)*

*Defined in [document/FieldStore.ts:29](https://github.com/cancerberoSgx/node-lucene/blob/7855316/node-lucene/src/document/FieldStore.ts#L29)*
...
• **get YES**(): *[FieldStore](_document_fieldstore_.fieldstore.md)*

*Defined in [document/FieldStore.ts:21](https://github.com/cancerberoSgx/node-lucene/blob/7855316/node-lucene/src/document/FieldStore.ts#L21)*
...
*Defined in [document/FieldStore.ts:17](https://github.com/cancerberoSgx/node-lucene/blob/7855316/node-lucene/src/document/FieldStore.ts#L17)*
