...
[Globals](../README.md) / ["java/util/EventObject"](../modules/_java_util_eventobject_.md) / [EventObject](_java_util_eventobject_.eventobject.md) /
...
* [constructor](_java_util_eventobject_.eventobject.md#constructor)

### Properties

* [_java](_java_util_eventobject_.eventobject.md#_java)

### Methods

* [_javaClassName](_java_util_eventobject_.eventobject.md#_javaclassname)
* [equals](_java_util_eventobject_.eventobject.md#equals)
* [equalsAsync](_java_util_eventobject_.eventobject.md#equalsasync)
* [equalsPromise](_java_util_eventobject_.eventobject.md#equalspromise)
* [equalsSync](_java_util_eventobject_.eventobject.md#equalssync)
* [getClass](_java_util_eventobject_.eventobject.md#getclass)
* [hashCode](_java_util_eventobject_.eventobject.md#hashcode)
* [toString](_java_util_eventobject_.eventobject.md#tostring)
* [toStringAsync](_java_util_eventobject_.eventobject.md#tostringasync)
* [toStringPromise](_java_util_eventobject_.eventobject.md#tostringpromise)
* [toStringSync](_java_util_eventobject_.eventobject.md#tostringsync)
* [_buildArraySync](_java_util_eventobject_.eventobject.md#static-_buildarraysync)
* [_buildAsync](_java_util_eventobject_.eventobject.md#static-protected-_buildasync)
* [_buildJavaArray](_java_util_eventobject_.eventobject.md#static-_buildjavaarray)
* [_buildPromise](_java_util_eventobject_.eventobject.md#static-protected-_buildpromise)
* [_buildSync](_java_util_eventobject_.eventobject.md#static-protected-_buildsync)
* [_buildSyncOrThrow](_java_util_eventobject_.eventobject.md#static-protected-_buildsyncorthrow)
* [_getNative](_java_util_eventobject_.eventobject.md#static-_getnative)
* [_javaClassName](_java_util_eventobject_.eventobject.md#static-_javaclassname)
* [class](_java_util_eventobject_.eventobject.md#static-class)

## Constructors

###  constructor

\+ **new EventObject**(): *[EventObject](_java_util_eventobject_.eventobject.md)*

*Overrides [Object_](_java_lang_object_.object_.md).[constructor](_java_lang_object_.object_.md#constructor)*

*Defined in [java/util/EventObject.ts:4](https://github.com/cancerberoSgx/node-lucene/blob/7855316/node-java-rt/src/java/util/EventObject.ts#L4)*

**Returns:** *[EventObject](_java_util_eventobject_.eventobject.md)*
...
*Defined in [java/util/EventObject.ts:10](https://github.com/cancerberoSgx/node-lucene/blob/7855316/node-java-rt/src/java/util/EventObject.ts#L10)*
