...
[Globals](../README.md) / ["java/nio/file/Paths"](../modules/_java_nio_file_paths_.md) / [Paths](_java_nio_file_paths_.paths.md) /
...
* [constructor](_java_nio_file_paths_.paths.md#constructor)

### Properties

* [_java](_java_nio_file_paths_.paths.md#_java)

### Methods

* [_javaClassName](_java_nio_file_paths_.paths.md#_javaclassname)
* [equals](_java_nio_file_paths_.paths.md#equals)
* [equalsAsync](_java_nio_file_paths_.paths.md#equalsasync)
* [equalsPromise](_java_nio_file_paths_.paths.md#equalspromise)
* [equalsSync](_java_nio_file_paths_.paths.md#equalssync)
* [getClass](_java_nio_file_paths_.paths.md#getclass)
* [hashCode](_java_nio_file_paths_.paths.md#hashcode)
* [toString](_java_nio_file_paths_.paths.md#tostring)
* [toStringAsync](_java_nio_file_paths_.paths.md#tostringasync)
* [toStringPromise](_java_nio_file_paths_.paths.md#tostringpromise)
* [toStringSync](_java_nio_file_paths_.paths.md#tostringsync)
* [_buildArraySync](_java_nio_file_paths_.paths.md#static-_buildarraysync)
* [_buildAsync](_java_nio_file_paths_.paths.md#static-protected-_buildasync)
* [_buildJavaArray](_java_nio_file_paths_.paths.md#static-_buildjavaarray)
* [_buildPromise](_java_nio_file_paths_.paths.md#static-protected-_buildpromise)
* [_buildSync](_java_nio_file_paths_.paths.md#static-protected-_buildsync)
* [_buildSyncOrThrow](_java_nio_file_paths_.paths.md#static-protected-_buildsyncorthrow)
* [_getNative](_java_nio_file_paths_.paths.md#static-_getnative)
* [_javaClassName](_java_nio_file_paths_.paths.md#static-_javaclassname)
* [class](_java_nio_file_paths_.paths.md#static-class)
* [get](_java_nio_file_paths_.paths.md#static-get)
* [getSync](_java_nio_file_paths_.paths.md#static-getsync)

## Constructors

###  constructor

\+ **new Paths**(): *[Paths](_java_nio_file_paths_.paths.md)*

*Overrides [Object_](_java_lang_object_.object_.md).[constructor](_java_lang_object_.object_.md#constructor)*

*Defined in [java/nio/file/Paths.ts:6](https://github.com/cancerberoSgx/node-lucene/blob/7855316/node-java-rt/src/java/nio/file/Paths.ts#L6)*

**Returns:** *[Paths](_java_nio_file_paths_.paths.md)*
...
*Defined in [java/nio/file/Paths.ts:12](https://github.com/cancerberoSgx/node-lucene/blob/7855316/node-java-rt/src/java/nio/file/Paths.ts#L12)*
...
▸ **get**(...`files`: string[]): *[Path](../interfaces/_java_nio_file_path_.path.md)*

*Defined in [java/nio/file/Paths.ts:22](https://github.com/cancerberoSgx/node-lucene/blob/7855316/node-java-rt/src/java/nio/file/Paths.ts#L22)*
...
**Returns:** *[Path](../interfaces/_java_nio_file_path_.path.md)*

___

### `Static` getSync

▸ **getSync**(...`files`: string[]): *[Path](../interfaces/_java_nio_file_path_.path.md)*

*Defined in [java/nio/file/Paths.ts:16](https://github.com/cancerberoSgx/node-lucene/blob/7855316/node-java-rt/src/java/nio/file/Paths.ts#L16)*
