...
[Globals](../README.md) / ["java/lang/Double"](../modules/_java_lang_double_.md) / [Double](_java_lang_double_.double.md) /
...
* [constructor](_java_lang_double_.double.md#constructor)

### Properties

* [_java](_java_lang_double_.double.md#_java)

### Methods

* [_javaClassName](_java_lang_double_.double.md#_javaclassname)
* [equals](_java_lang_double_.double.md#equals)
* [equalsAsync](_java_lang_double_.double.md#equalsasync)
* [equalsPromise](_java_lang_double_.double.md#equalspromise)
* [equalsSync](_java_lang_double_.double.md#equalssync)
* [getClass](_java_lang_double_.double.md#getclass)
* [hashCode](_java_lang_double_.double.md#hashcode)
* [toString](_java_lang_double_.double.md#tostring)
* [toStringAsync](_java_lang_double_.double.md#tostringasync)
* [toStringPromise](_java_lang_double_.double.md#tostringpromise)
* [toStringSync](_java_lang_double_.double.md#tostringsync)
* [_buildArraySync](_java_lang_double_.double.md#static-_buildarraysync)
* [_buildAsync](_java_lang_double_.double.md#static-protected-_buildasync)
* [_buildJavaArray](_java_lang_double_.double.md#static-_buildjavaarray)
* [_buildPromise](_java_lang_double_.double.md#static-protected-_buildpromise)
* [_buildSync](_java_lang_double_.double.md#static-protected-_buildsync)
* [_buildSyncOrThrow](_java_lang_double_.double.md#static-protected-_buildsyncorthrow)
* [_getNative](_java_lang_double_.double.md#static-_getnative)
* [_javaClassName](_java_lang_double_.double.md#static-_javaclassname)
* [class](_java_lang_double_.double.md#static-class)
* [sum](_java_lang_double_.double.md#static-sum)

## Constructors

###  constructor

\+ **new Double**(`val`: string): *[Double](_java_lang_double_.double.md)*

*Overrides [Object_](_java_lang_object_.object_.md).[constructor](_java_lang_object_.object_.md#constructor)*

*Defined in [java/lang/Double.ts:6](https://github.com/cancerberoSgx/node-lucene/blob/7855316/node-java-rt/src/java/lang/Double.ts#L6)*
...
**Returns:** *[Double](_java_lang_double_.double.md)*
...
▸ **sum**(`a`: [Double](_java_lang_double_.double.md), `b`: [Double](_java_lang_double_.double.md)): *number*

*Defined in [java/lang/Double.ts:11](https://github.com/cancerberoSgx/node-lucene/blob/7855316/node-java-rt/src/java/lang/Double.ts#L11)*

**Parameters:**

Name | Type |
------ | ------ |
`a` | [Double](_java_lang_double_.double.md) |
`b` | [Double](_java_lang_double_.double.md) |
