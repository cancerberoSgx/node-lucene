...
[Globals](../README.md) / ["java/lang/ClassLoader"](../modules/_java_lang_classloader_.md) / [ClassLoader](_java_lang_classloader_.classloader.md) /
...
* [constructor](_java_lang_classloader_.classloader.md#constructor)

### Properties

* [_java](_java_lang_classloader_.classloader.md#_java)

### Methods

* [_javaClassName](_java_lang_classloader_.classloader.md#_javaclassname)
* [equals](_java_lang_classloader_.classloader.md#equals)
* [equalsAsync](_java_lang_classloader_.classloader.md#equalsasync)
* [equalsPromise](_java_lang_classloader_.classloader.md#equalspromise)
* [equalsSync](_java_lang_classloader_.classloader.md#equalssync)
* [getClass](_java_lang_classloader_.classloader.md#getclass)
* [hashCode](_java_lang_classloader_.classloader.md#hashcode)
* [loadClass](_java_lang_classloader_.classloader.md#loadclass)
* [toString](_java_lang_classloader_.classloader.md#tostring)
* [toStringAsync](_java_lang_classloader_.classloader.md#tostringasync)
* [toStringPromise](_java_lang_classloader_.classloader.md#tostringpromise)
* [toStringSync](_java_lang_classloader_.classloader.md#tostringsync)
* [_buildArraySync](_java_lang_classloader_.classloader.md#static-_buildarraysync)
* [_buildAsync](_java_lang_classloader_.classloader.md#static-protected-_buildasync)
* [_buildJavaArray](_java_lang_classloader_.classloader.md#static-_buildjavaarray)
* [_buildPromise](_java_lang_classloader_.classloader.md#static-protected-_buildpromise)
* [_buildSync](_java_lang_classloader_.classloader.md#static-protected-_buildsync)
* [_buildSyncOrThrow](_java_lang_classloader_.classloader.md#static-protected-_buildsyncorthrow)
* [_getNative](_java_lang_classloader_.classloader.md#static-_getnative)
* [_javaClassName](_java_lang_classloader_.classloader.md#static-_javaclassname)
* [class](_java_lang_classloader_.classloader.md#static-class)
* [getSystemClassLoader](_java_lang_classloader_.classloader.md#static-getsystemclassloader)

## Constructors

###  constructor

\+ **new ClassLoader**(): *[ClassLoader](_java_lang_classloader_.classloader.md)*
...
**Returns:** *[ClassLoader](_java_lang_classloader_.classloader.md)*
...
▸ **loadClass**(`className`: string): *[Class](_java_lang_class_.class.md)‹*any*›*

*Defined in [java/lang/ClassLoader.ts:11](https://github.com/cancerberoSgx/node-lucene/blob/7855316/node-java-rt/src/java/lang/ClassLoader.ts#L11)*
...
▸ **getSystemClassLoader**(): *[ClassLoader](_java_lang_classloader_.classloader.md)*

*Defined in [java/lang/ClassLoader.ts:6](https://github.com/cancerberoSgx/node-lucene/blob/7855316/node-java-rt/src/java/lang/ClassLoader.ts#L6)*
