...
[Globals](../README.md) / ["java/math/BigInteger"](../modules/_java_math_biginteger_.md) / [BigInteger](_java_math_biginteger_.biginteger.md) /
...
* [constructor](_java_math_biginteger_.biginteger.md#constructor)

### Properties

* [_java](_java_math_biginteger_.biginteger.md#_java)

### Methods

* [_javaClassName](_java_math_biginteger_.biginteger.md#_javaclassname)
* [equals](_java_math_biginteger_.biginteger.md#equals)
* [equalsAsync](_java_math_biginteger_.biginteger.md#equalsasync)
* [equalsPromise](_java_math_biginteger_.biginteger.md#equalspromise)
* [equalsSync](_java_math_biginteger_.biginteger.md#equalssync)
* [getClass](_java_math_biginteger_.biginteger.md#getclass)
* [hashCode](_java_math_biginteger_.biginteger.md#hashcode)
* [multiply](_java_math_biginteger_.biginteger.md#multiply)
* [toString](_java_math_biginteger_.biginteger.md#tostring)
* [toStringAsync](_java_math_biginteger_.biginteger.md#tostringasync)
* [toStringPromise](_java_math_biginteger_.biginteger.md#tostringpromise)
* [toStringSync](_java_math_biginteger_.biginteger.md#tostringsync)
* [_buildArraySync](_java_math_biginteger_.biginteger.md#static-_buildarraysync)
* [_buildAsync](_java_math_biginteger_.biginteger.md#static-protected-_buildasync)
* [_buildJavaArray](_java_math_biginteger_.biginteger.md#static-_buildjavaarray)
* [_buildPromise](_java_math_biginteger_.biginteger.md#static-protected-_buildpromise)
* [_buildSync](_java_math_biginteger_.biginteger.md#static-protected-_buildsync)
* [_buildSyncOrThrow](_java_math_biginteger_.biginteger.md#static-protected-_buildsyncorthrow)
* [_getNative](_java_math_biginteger_.biginteger.md#static-_getnative)
* [_javaClassName](_java_math_biginteger_.biginteger.md#static-_javaclassname)
* [class](_java_math_biginteger_.biginteger.md#static-class)

## Constructors

###  constructor

\+ **new BigInteger**(`val`: string): *[BigInteger](_java_math_biginteger_.biginteger.md)*

*Overrides [Object_](_java_lang_object_.object_.md).[constructor](_java_lang_object_.object_.md#constructor)*

*Defined in [java/math/BigInteger.ts:5](https://github.com/cancerberoSgx/node-lucene/blob/7855316/node-java-rt/src/java/math/BigInteger.ts#L5)*
...
**Returns:** *[BigInteger](_java_math_biginteger_.biginteger.md)*
...
▸ **multiply**(`i`: [BigInteger](_java_math_biginteger_.biginteger.md)): *[BigInteger](_java_math_biginteger_.biginteger.md)*

*Defined in [java/math/BigInteger.ts:10](https://github.com/cancerberoSgx/node-lucene/blob/7855316/node-java-rt/src/java/math/BigInteger.ts#L10)*

**Parameters:**

Name | Type |
------ | ------ |
`i` | [BigInteger](_java_math_biginteger_.biginteger.md) |
