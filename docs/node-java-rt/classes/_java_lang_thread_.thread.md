...
[Globals](../README.md) / ["java/lang/Thread"](../modules/_java_lang_thread_.md) / [Thread](_java_lang_thread_.thread.md) /
...
* [constructor](_java_lang_thread_.thread.md#constructor)

### Properties

* [_java](_java_lang_thread_.thread.md#_java)

### Methods

* [_javaClassName](_java_lang_thread_.thread.md#_javaclassname)
* [equals](_java_lang_thread_.thread.md#equals)
* [equalsAsync](_java_lang_thread_.thread.md#equalsasync)
* [equalsPromise](_java_lang_thread_.thread.md#equalspromise)
* [equalsSync](_java_lang_thread_.thread.md#equalssync)
* [getClass](_java_lang_thread_.thread.md#getclass)
* [hashCode](_java_lang_thread_.thread.md#hashcode)
* [toString](_java_lang_thread_.thread.md#tostring)
* [toStringAsync](_java_lang_thread_.thread.md#tostringasync)
* [toStringPromise](_java_lang_thread_.thread.md#tostringpromise)
* [toStringSync](_java_lang_thread_.thread.md#tostringsync)
* [_buildArraySync](_java_lang_thread_.thread.md#static-_buildarraysync)
* [_buildAsync](_java_lang_thread_.thread.md#static-protected-_buildasync)
* [_buildJavaArray](_java_lang_thread_.thread.md#static-_buildjavaarray)
* [_buildPromise](_java_lang_thread_.thread.md#static-protected-_buildpromise)
* [_buildSync](_java_lang_thread_.thread.md#static-protected-_buildsync)
* [_buildSyncOrThrow](_java_lang_thread_.thread.md#static-protected-_buildsyncorthrow)
* [_getNative](_java_lang_thread_.thread.md#static-_getnative)
* [_javaClassName](_java_lang_thread_.thread.md#static-_javaclassname)
* [class](_java_lang_thread_.thread.md#static-class)
* [newJavaThread](_java_lang_thread_.thread.md#static-newjavathread)

## Constructors

###  constructor

\+ **new Thread**(): *[Thread](_java_lang_thread_.thread.md)*
...
**Returns:** *[Thread](_java_lang_thread_.thread.md)*
...
### `Static` newJavaThread

▸ **newJavaThread**(`run`: function): *any*

*Defined in [java/lang/Thread.ts:10](https://github.com/cancerberoSgx/node-lucene/blob/7855316/node-java-rt/src/java/lang/Thread.ts#L10)*
