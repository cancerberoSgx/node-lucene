...
export class JavaBase implements IJavaBase {
  ...
  /** @internal */
  protected static _buildSync<T extends JavaBase>(javaObject: any, instance: T): T {
    instance._java = javaObject
    return instance
  }

  /** @internal */
  protected static _buildAsync<T extends JavaBase>(callback: Callback<T>, instance: T): (error: any, javaObject: any) => void {
